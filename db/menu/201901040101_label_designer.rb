Crossbeams::MenuMigrations::Migrator.migration('LabelDesigner') do
  up do
    ...
    if ENV['CLIENT_CODE'] == 'srcc'
      ...
      add_program_function 'Container Types', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=container_type', seq: 1
      add_program_function 'Commodities', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=commodity', seq: 2
      add_program_function 'Markets', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=market', seq: 3
      add_program_function 'Languages', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=language', seq: 4
      add_program_function 'Categories', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=category', seq: 5
      add_program_function 'Sub-categories', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=sub_category', seq: 6
    end

    if ENV['CLIENT_CODE'] == 'tad'
      add_program_function 'Label Types', functional_area: 'Label Designer', program: 'Master Lists', url: '/list/master_lists/with_params?key=label_type'
    end
  end
